...
import { Home, GraduationCap, Award, User, HelpCircle, Menu } from "lucide-react";
...
const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  const menuItems = [
    { id: "Counselling", label: "Counselling", description: "NEET Counselling Process" },
    { id: "support", label: "Support", description: "Get Help & Assistance" },
    { id: "universities", label: "Universities", description: "Medical Colleges" },
    { id: "results", label: "Results & Rankings", description: "NIRF Rankings" },
  ];
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className={`font-semibold ${
                        activeSection === item.id ? "text-blue-700" : "text-slate-800"
                      }`}>
                        {item.label}
                      </h4>
                    ...
                    <div className={`w-2 h-2 rounded-full ${
                      activeSection === item.id ? "bg-blue-500" : "bg-slate-300"
                    }`} />
                  </div>
                </button>
              ))}
